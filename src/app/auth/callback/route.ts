...
import { exchangeCodeForSession } from '@/lib/data/auth.repo'
import { getPostAuthDestination, LOGIN_PATH } from '@/lib/domain/auth'
...
function loginRedirect(requestUrl: URL, message: string) {
  const url = new URL(LOGIN_PATH, requestUrl.origin)
